...
window.onload = () => {
    ...
    void (async () => {
        try {
            ...
            await Promise.all([westendProvider, kusamaProvider, polkadotProvider].map((p) => p.connect()));
            ...
            const westmintProvider = new ScProvider(JSON.stringify(westmint), westendProvider);
